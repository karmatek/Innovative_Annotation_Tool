...
api_key='DGsHHqLj5dDNSpIIRBS11kbQW00d9gjwslNUyEEHSKnl')
...
#car_path = join(dirname(__file__), '..\moles\moles.zip')
#car_path = dirname("C:\Users\veeti\PycharmProjects\IAT\testdata\moles\moles.zip")

car_path= Path("C:/Users/veeti/PycharmProjects/IAT/testdata/moles/mole.jpg")
